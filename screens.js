var processor = {};
    ...
    $(document).ready(function() {
      ...
      processor.doLoad = function doLoad() {
        ...
        let frame2 = document.getElementById("img2");
        ...
        ctx1.drawImage(frame, 0, 0, c1.width, c1.height);
        frame = c1.toDataURL('image/jpeg');

        ctx3.drawImage(frame2, 0, 0, c3.width, c3.height);
        frame2 = c3.toDataURL('image/jpeg');

        function grayscale() {

          frame = ctx1.getImageData(0, 0, c1.width, c1.height);
        ...
        function sobel2() {
          frame2 = ctx3.getImageData(0, 0, c3.width, c3.height);
          frame2 = sobel2nd(frame2);
          ctx3.putImageData(frame2, 0, 0);
      ...
      var sobel2nd = function sobel(px2) {
        ...
        var vertical = processor.convoluteFloat32(px, [-r4, -r5, -r6,
          0, 0, 0,
          r4, r5, r6
        ]);
        var horizontal = processor.convoluteFloat32(px, [-r6, 0, r6, -r5, 0, r5, -r4, 0, r4]);
      ...
      var sobel = function sobel(px) {
        ...
        var vertical = processor.convoluteFloat32(px, [-r1, -r2, -r3,
          0, 0, 0,
          r1, r2, r3
        ]);
        var horizontal = processor.convoluteFloat32(px, [-r3, 0, r3, -r2, 0, r2, -r1, 0, r1]);
        var id = processor.createImageData(vertical.width, vertical.height);
        for (var i = 0; i < id.data.length; i += 4) {
          var v = Math.abs(vertical.data[i]);
          id.data[i] = v;
